...
ggtheme_descriptive_plot <- function(angletext_yaxis=0, angletext_xaxis=0,
  ...
  theme_set(theme_minimal() +
              theme(
                ...
                axis.text.y = element_text(angle = angletext_yaxis, lineheight = 0.7, hjust = 0.5, size=11),
                axis.text.x = element_text(angle = angletext_xaxis, lineheight = 0.7, vjust = 0.5, size=11),
