...
## Save Crude Odds Ratio and Adjusted Odds Ratio output (Only saves flextable objects)

flextable::save_as_docx(values = crude_odds_ratio_categorical_merge,
                        path = base::file.path(output_Dir, "CoR_university_community.docx"),
...
flextable::save_as_docx(values = adjusted_odds_ratio_categorical_match_merge,
                        path = base::file.path(output_Dir, "AoR_university_community_match.docx"),
                        align = "center", #left, center (default) or right.
                        pr_section = officer::prop_section(
                          page_size = officer::page_size(orient = "landscape"), #Use NULL (default value) for no content.
                          page_margins = officer::page_mar(), #Use NULL (default value) for no content.
