...
flextable::save_as_docx(crude_odds_ratio_categorical_combined_merge,
                        path = base::file.path(output_Dir, "CoR_combined_population.docx"),
                        align = "center", #left, center (default) or right.
                        pr_section = officer::prop_section(
                          page_size = officer::page_size(orient = "landscape"), #Use NULL (default value) for no content.
                          page_margins = officer::page_mar(), #Use NULL (default value) for no content.
...
flextable::save_as_docx(adjusted_odds_ratio_categorical_combined_match_merge,
                        path = base::file.path(output_Dir, "AoR_combined_population_match.docx"),
                        align = "center", #left, center (default) or right.
                        pr_section = officer::prop_section(
                          page_size = officer::page_size(orient = "landscape"), #Use NULL (default value) for no content.
                          page_margins = officer::page_mar(), #Use NULL (default value) for no content.
